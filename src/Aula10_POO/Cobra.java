...
public class Cobra extends Generico{
    ...
    public void ataque(HeroiGenerico heroi) {
        ...
        System.out.println("A cobra lhe causou "+this.dano+" pontos de dano.");
    ...
    public void apanhar(HeroiGenerico heroi) {
        ...
        if (heroi.getTipoDano().equals("Pancada")){
            System.out.println("Este monstro é fraco contra o elemento da terra.");
            dano = dano * 2;
        }
        System.out.println("A cobra recebeu " + dano + " pontos de dano.");
